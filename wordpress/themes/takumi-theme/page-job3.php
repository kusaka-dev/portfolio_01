...
<div class="p-content">
  <div class="l-inner">
    ...
    <div class="c-section-title p-recruit-section-title js-fade-in">
      <h2 class="c-section-title__jp">CADオペレーター</h2>
    ...
    <dl class="c-table js-fade-in">
      ...
      <dt>業務内容</dt>
      <dd>
        建築設計・施工に関する図面の作成・修正（AutoCAD、Revit、Vectorworks など使用）<br>
        設計士・施工管理士との連携による図面作成<br>
        各種申請用図面の作成補助<br>
        建築・設備図面のトレース作業<br>
        BIMソフトを活用した3Dモデリング（経験者優遇）
      </dd>
      <dt>応募資格</dt>
      <dd>
        【必須条件】
        <ul>
          <li>CADソフト（AutoCAD、Revit、Vectorworks など）を使用した図面作成経験（1年以上）</li>
          <li>建築・設備に関する基本的な知識</li>
          <li>正確でスピーディな作業ができる方</li>
        </ul>
        <br>
        【歓迎条件】
        <ul>
          <li>BIM（Building Information Modeling）の経験</li>
          <li>建築設計事務所や施工会社での実務経験</li>
          <li>一級・二級建築士、または建築CAD検定の資格保有者</li>
        </ul>
      </dd>
      <dt>雇用形態</dt>
      <dd>
      ...
      <dt>給与</dt>
      <dd>
        月給 250,000円～500,000円（経験・能力を考慮の上、決定）<br>
        時給制（アルバイト・パートの場合）：1,500円～
      </dd>
      <dt>福利厚生</dt>
      <dd>
        社会保険完備（正社員・契約社員）<br>
